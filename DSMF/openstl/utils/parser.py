...
def create_parser():
    ...
    parser.add_argument('--data_root', default='/scratch/mingze/data')
    parser.add_argument('--dataname', '-d', default='mmnist', type=str,
                        choices=['bair', 'mfmnist', 'mmnist', 'mmnist_cifar', 'noisymmnist', 'taxibj', 'human',
                                ...
                                'sevir_vis', 'sevir_ir069', 'sevir_ir107', 'sevir_vil', 'weather_tcc_2_8125','weather_tp_5_625', 'weather_tp_2_8125', 'weather_tp_1_40625'],
...
def default_parser():
    default_values = {
        ...
        'val_batch_size': 16,
        'num_workers': 4,
        'data_root': '/scratch/jiabing/data/data',
        'dataname': 'weather',
        'pre_seq_length': 12,
        'aft_seq_length': 12,
        'total_length': 24,
