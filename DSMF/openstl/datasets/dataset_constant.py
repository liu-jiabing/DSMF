    ...
    **dict.fromkeys(['weather', 'weather_t2m_5_625'], {  # 2m_temperature
    ...
    'weather_tcc_5_625': {  # total_cloud_cover
     ...
     'weather_tp_5_625': {  # total_cloud_cover
        ...
        'data_name': 'tp',
        'train_time': ['2010', '2015'], 'val_time': ['2016', '2016'], 'test_time': ['2017', '2018'],
        'metrics': ['mse', 'rmse', 'mae', 'psnr', 'ssim', 'snr','pod'],
    },
    'weather_tcc_2_8125': {  # total_cloud_cover
        ...
        'data_name': 'tcc',
        'train_time': ['2010', '2015'], 'val_time': ['2016', '2016'], 'test_time': ['2017', '2018'],
        'metrics': ['mse', 'rmse', 'mae', 'psnr', 'ssim', 'snr'],
    },
    ...
    'weather_tp_1_40625': {  # relative_humidity
        'in_shape': [12, 1, 128, 256],
        'pre_seq_length': 12,
        'aft_seq_length': 12,
        'total_length': 24,
        'data_name': 'tp',
        'train_time': ['2010', '2015'], 'val_time': ['2016', '2016'], 'test_time': ['2017', '2017'],
        'metrics': ['mse', 'rmse', 'mae', 'psnr', 'ssim', 'snr','pod'],
    },
